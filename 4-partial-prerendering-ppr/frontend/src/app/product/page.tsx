...
/** PPR demo page â€” static shell prerender; Suspense wraps the dynamic CartCount hole. */
  ...
  return (
    <main className="min-h-screen bg-background p-3">
      <div className="mx-auto max-w-2xl">
        <LessonShell
          title="Product page"
          description="Static product shell plus a dynamic cart hole â€” both stream in one response when PPR is enabled."
          ...
          alertTip="Tip: change cart_count between reloads â€” only the hole updates; the static shell stays the same."
        >
